									 ...
									 AFPVolMountInfoPtr *afpInfoPtr)
{
	...
	if ( infoPtr != NULL )
	{
		...
		infoPtr->zoneNameOffset = OFFSET_OF(MyAFPVolMountInfo, zoneName);
		infoPtr->serverNameOffset = OFFSET_OF(MyAFPVolMountInfo, serverName);
		infoPtr->volNameOffset = OFFSET_OF(MyAFPVolMountInfo, volName);
		infoPtr->userNameOffset = OFFSET_OF(MyAFPVolMountInfo, userName);
		infoPtr->userPasswordOffset = OFFSET_OF(MyAFPVolMountInfo, userPassword);
		infoPtr->volPasswordOffset = OFFSET_OF(MyAFPVolMountInfo, volPassword);
									  ...
									  AFPXVolMountInfoPtr *afpXInfoPtr)
{
	...
	if ( infoPtr != NULL )
	{
		...
		infoPtr->zoneNameOffset = OFFSET_OF(MyAFPXVolMountInfo, zoneName);		
		infoPtr->serverNameOffset = OFFSET_OF(MyAFPXVolMountInfo, serverName);
		infoPtr->volNameOffset = OFFSET_OF(MyAFPXVolMountInfo, volName);
		infoPtr->userNameOffset = OFFSET_OF(MyAFPXVolMountInfo, userName);
		infoPtr->userPasswordOffset = OFFSET_OF(MyAFPXVolMountInfo, userPassword);
		infoPtr->volPasswordOffset = OFFSET_OF(MyAFPXVolMountInfo, volPassword);
		infoPtr->uamNameOffset = OFFSET_OF(MyAFPXVolMountInfo, uamName);
		infoPtr->alternateAddressOffset = OFFSET_OF(MyAFPXVolMountInfo, alternateAddress);

/*
 	...
 	Copyright:	(c) 1986-1998, 1995-1997 by Apple Computer, Inc., all rights reserved
...
NewADSPConnectionEventProc	   (ADSPConnectionEventProcPtr userRoutine);
EXTERN_API(ADSPCompletionUPP)
NewADSPCompletionProc		   (ADSPCompletionProcPtr	userRoutine);
EXTERN_API(void)
CallADSPConnectionEventProc	   (ADSPConnectionEventUPP	userRoutine,
								TPCCB					sourceCCB);
EXTERN_API(void)
CallADSPCompletionProc		   (ADSPCompletionUPP		userRoutine,
								DSPPBPtr				thePBPtr);
#else

...
NewATAClientProc			   (ATAClientProcPtr		userRoutine);
EXTERN_API(SInt16)
CallATAClientProc			   (ATAClientUPP			userRoutine,
...
NewATADispatchProc			   (ATADispatchProcPtr		userRoutine);
EXTERN_API(OSErr)
CallATADispatchProc			   (ATADispatchUPP			userRoutine,
								ataPB *					pb);
#else

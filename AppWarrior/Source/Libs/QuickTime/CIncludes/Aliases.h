/*
 	...
 	Copyright:	(c) 1989-1995, 1997-1998 by Apple Computer, Inc., all rights reserved
...
NewAliasFilterProc			   (AliasFilterProcPtr		userRoutine);
EXTERN_API(Boolean)
CallAliasFilterProc			   (AliasFilterUPP			userRoutine,
								CInfoPBPtr				cpbPtr,
								Boolean *				quitFlag,
								Ptr						myDataPtr);
#else

...
NewAEEventHandlerProc		   (AEEventHandlerProcPtr	userRoutine);
EXTERN_API(AEIdleUPP)
NewAEIdleProc				   (AEIdleProcPtr			userRoutine);
EXTERN_API(AEFilterUPP)
NewAEFilterProc				   (AEFilterProcPtr			userRoutine);
EXTERN_API(OSErr)
CallAEEventHandlerProc		   (AEEventHandlerUPP		userRoutine,
								const AppleEvent *		theAppleEvent,
								AppleEvent *			reply,
								UInt32					handlerRefcon);
EXTERN_API(Boolean)
CallAEIdleProc				   (AEIdleUPP				userRoutine,
								EventRecord *			theEvent,
								long *					sleepTime,
								RgnHandle *				mouseRgn);
EXTERN_API(Boolean)
CallAEFilterProc			   (AEFilterUPP				userRoutine,
								EventRecord *			theEvent,
								long					returnID,
								long					transactionID,

...
NewCMFlattenProc			   (CMFlattenProcPtr		userRoutine);
EXTERN_API(CMBitmapCallBackUPP)
NewCMBitmapCallBackProc		   (CMBitmapCallBackProcPtr	userRoutine);
EXTERN_API(CMProfileFilterUPP)
NewCMProfileFilterProc		   (CMProfileFilterProcPtr	userRoutine);
EXTERN_API(CMProfileAccessUPP)
NewCMProfileAccessProc		   (CMProfileAccessProcPtr	userRoutine);
EXTERN_API(OSErr)
CallCMFlattenProc			   (CMFlattenUPP			userRoutine,
								long					command,
								long *					size,
								void *					data,
								void *					refCon);
EXTERN_API(Boolean)
CallCMBitmapCallBackProc	   (CMBitmapCallBackUPP		userRoutine,
								long					progress,
								void *					refCon);
EXTERN_API(Boolean)
CallCMProfileFilterProc		   (CMProfileFilterUPP		userRoutine,
								CMProfileRef			prof,
								void *					refCon);
EXTERN_API(OSErr)
CallCMProfileAccessProc		   (CMProfileAccessUPP		userRoutine,
								long					command,
								long					offset,
								long *					size,
								void *					data,
...
NewCMProfileIterateProc		   (CMProfileIterateProcPtr	userRoutine);
EXTERN_API(OSErr)
CallCMProfileIterateProc	   (CMProfileIterateUPP		userRoutine,

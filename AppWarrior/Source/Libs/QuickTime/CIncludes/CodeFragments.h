...
#define kBaseCFragResourceMemberSize	(OFFSET_OF ( CFragResourceMember, name ) )
#define kBaseCFragResourceSize			(OFFSET_OF ( CFragResource, firstMember.name ) )
...
#define FirstCFragResourceSearchQualifier(searchExtensionPtr)					\
		((StringPtr) ((BytePtr)searchExtensionPtr +								\
					  OFFSET_OF ( CFragResourceSearchExtension, qualifiers ) ))

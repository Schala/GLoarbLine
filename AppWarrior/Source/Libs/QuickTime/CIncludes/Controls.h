...
NewControlActionProc		   (ControlActionProcPtr	userRoutine);
EXTERN_API(void)
CallControlActionProc		   (ControlActionUPP		userRoutine,
...
/*------------------------------------------------------------------------------------------------------*/
/*	o Errors are in the range -30580 .. -30599															*/
/*------------------------------------------------------------------------------------------------------*/
...
NewControlKeyFilterProc		   (ControlKeyFilterProcPtr	userRoutine);
EXTERN_API(ControlKeyFilterResult)
CallControlKeyFilterProc	   (ControlKeyFilterUPP		userRoutine,
								ControlHandle			theControl,
								SInt16 *				keyCode,
								SInt16 *				charCode,
								SInt16 *				modifiers);
...
NewControlUserPaneDrawProc	   (ControlUserPaneDrawProcPtr userRoutine);
EXTERN_API(ControlUserPaneHitTestUPP)
NewControlUserPaneHitTestProc    (ControlUserPaneHitTestProcPtr userRoutine);
EXTERN_API(ControlUserPaneTrackingUPP)
NewControlUserPaneTrackingProc    (ControlUserPaneTrackingProcPtr userRoutine);
EXTERN_API(ControlUserPaneIdleUPP)
NewControlUserPaneIdleProc	   (ControlUserPaneIdleProcPtr userRoutine);
EXTERN_API(ControlUserPaneKeyDownUPP)
NewControlUserPaneKeyDownProc    (ControlUserPaneKeyDownProcPtr userRoutine);
EXTERN_API(ControlUserPaneActivateUPP)
NewControlUserPaneActivateProc    (ControlUserPaneActivateProcPtr userRoutine);
EXTERN_API(ControlUserPaneFocusUPP)
NewControlUserPaneFocusProc	   (ControlUserPaneFocusProcPtr userRoutine);
EXTERN_API(ControlUserPaneBackgroundUPP)
NewControlUserPaneBackgroundProc    (ControlUserPaneBackgroundProcPtr userRoutine);
EXTERN_API(void)
CallControlUserPaneDrawProc	   (ControlUserPaneDrawUPP	userRoutine,
								ControlHandle			control,
								SInt16					part);
EXTERN_API(ControlPartCode)
CallControlUserPaneHitTestProc    (ControlUserPaneHitTestUPP userRoutine,
								ControlHandle			control,
								Point					where);
EXTERN_API(ControlPartCode)
CallControlUserPaneTrackingProc    (ControlUserPaneTrackingUPP userRoutine,
								ControlHandle			control,
								Point					startPt,
								ControlActionUPP		actionProc);
EXTERN_API(void)
CallControlUserPaneIdleProc	   (ControlUserPaneIdleUPP	userRoutine,
								ControlHandle			control);
EXTERN_API(ControlPartCode)
CallControlUserPaneKeyDownProc    (ControlUserPaneKeyDownUPP userRoutine,
								ControlHandle			control,
								SInt16					keyCode,
								SInt16					charCode,
								SInt16					modifiers);
EXTERN_API(void)
CallControlUserPaneActivateProc    (ControlUserPaneActivateUPP userRoutine,
								ControlHandle			control,
								Boolean					activating);
EXTERN_API(ControlPartCode)
CallControlUserPaneFocusProc    (ControlUserPaneFocusUPP userRoutine,
								ControlHandle			control,
								ControlFocusPart		action);
EXTERN_API(void)
CallControlUserPaneBackgroundProc    (ControlUserPaneBackgroundUPP userRoutine,
								ControlHandle			control,
...
NewControlEditTextValidationProc    (ControlEditTextValidationProcPtr userRoutine);
EXTERN_API(void)
CallControlEditTextValidationProc    (ControlEditTextValidationUPP userRoutine,
								ControlHandle			control);
#else
...
/*--------------------------------------------------------------------------------------*/
/*	o HELPERS (available only with Appearance 1.0 and later)							*/
/*																						*/
...
NewControlDefProc			   (ControlDefProcPtr		userRoutine);
EXTERN_API(SInt32)
CallControlDefProc			   (ControlDefUPP			userRoutine,
								SInt16					varCode,
								ControlHandle			theControl,
...
/* Getters */
EXTERN_API( ControlHandle )
GetNextControl					(ControlHandle 			control);

EXTERN_API( Rect *)
GetControlBounds				(ControlHandle 			control,
								 Rect *					bounds);

EXTERN_API( Boolean )
IsControlHilited				(ControlHandle 			control);

EXTERN_API( WindowPtr )
GetControlOwner					(ControlHandle 			control);

EXTERN_API( Handle )
GetControlDefinition			(ControlHandle 			control);

EXTERN_API( MenuHandle )
GetControlPopupMenuHandle		(ControlHandle 			control);

EXTERN_API( short )
GetControlPopupMenuID			(ControlHandle 			control);

EXTERN_API( CCTabHandle )
GetControlColorTable			(ControlHandle 			control);

/* Setters */
EXTERN_API( void )
SetNextControl					(ControlHandle 			control,
								 ControlHandle 			nextControl);

EXTERN_API( void )
SetControlBounds				(ControlHandle 			control,
								 Rect *					bounds);

EXTERN_API( void )
SetControlPopupMenuHandle		(ControlHandle 			control,
								 MenuHandle 			popupMenu);

EXTERN_API( void )
SetControlPopupMenuID			(ControlHandle 			control,
								 short 					menuID);

EXTERN_API( void )
SetControlColorTable			(ControlHandle 			control,
								 CCTabHandle 			ccolorTable);

/* Utilities */
EXTERN_API( ControlHandle )
GetControlOwningWindowControlList (WindowPtr 			owner);

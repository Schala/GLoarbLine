/*
 	...
 	Copyright:	(c) 1987-1998 by Apple Computer, Inc., all rights reserved
...
NewADBCompletionProc		   (ADBCompletionProcPtr	userRoutine);
EXTERN_API(ADBDeviceDriverUPP)
NewADBDeviceDriverProc		   (ADBDeviceDriverProcPtr	userRoutine);
EXTERN_API(ADBServiceRoutineUPP)
NewADBServiceRoutineProc	   (ADBServiceRoutineProcPtr userRoutine);
EXTERN_API(ADBInitUPP)
NewADBInitProc				   (ADBInitProcPtr			userRoutine);
EXTERN_API(void)
CallADBCompletionProc		   (ADBCompletionUPP		userRoutine,
								Ptr						buffer,
								Ptr						refCon,
								long					command);
EXTERN_API(void)
CallADBDeviceDriverProc		   (ADBDeviceDriverUPP		userRoutine,
								SInt8					devAddress,
								SInt8					devType);
EXTERN_API(void)
CallADBServiceRoutineProc	   (ADBServiceRoutineUPP	userRoutine,
								Ptr						buffer,
								TempADBServiceRoutineUPP completionProc,
								Ptr						refCon,
								long					command);
EXTERN_API(void)
CallADBInitProc				   (ADBInitUPP				userRoutine,
								SInt8					callOrder);
#else

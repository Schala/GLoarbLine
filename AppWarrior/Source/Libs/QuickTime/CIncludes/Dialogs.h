...
EXTERN_API(SoundUPP)
NewSoundProc				   (SoundProcPtr			userRoutine);
EXTERN_API(ModalFilterUPP)
NewModalFilterProc			   (ModalFilterProcPtr		userRoutine);
EXTERN_API(UserItemUPP)
NewUserItemProc				   (UserItemProcPtr			userRoutine);
EXTERN_API(void)
CallSoundProc				   (SoundUPP				userRoutine,
								SInt16					soundNumber);
EXTERN_API(Boolean)
CallModalFilterProc			   (ModalFilterUPP			userRoutine,
								DialogPtr				theDialog,
								EventRecord *			theEvent,
								DialogItemIndex *		itemHit);
EXTERN_API(void)
CallUserItemProc			   (UserItemUPP				userRoutine,
								WindowPtr				theWindow,
...
EXTERN_API( SInt32 )
GetDialogRefCon					(DialogPtr 				dialog);

/* Setters */
EXTERN_API( void )
SetDialogRefCon					(DialogPtr 				dialog,
								 SInt32 				refCon);

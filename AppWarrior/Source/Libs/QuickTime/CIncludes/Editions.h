...
NewExpModalFilterProc		   (ExpModalFilterProcPtr	userRoutine);
EXTERN_API(ExpDlgHookUPP)
NewExpDlgHookProc			   (ExpDlgHookProcPtr		userRoutine);
EXTERN_API(Boolean)
CallExpModalFilterProc		   (ExpModalFilterUPP		userRoutine,
								DialogPtr				theDialog,
								...
								Ptr						yourDataPtr);
EXTERN_API(short)
CallExpDlgHookProc			   (ExpDlgHookUPP			userRoutine,
								short					itemOffset,
								short					itemHit,
								DialogPtr				theDialog,
								Ptr						yourDataPtr);
...
NewFormatIOProc				   (FormatIOProcPtr			userRoutine);
EXTERN_API(EditionOpenerUPP)
NewEditionOpenerProc		   (EditionOpenerProcPtr	userRoutine);
#else

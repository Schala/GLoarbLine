...
NewLg2PhysProc				   (Lg2PhysProcPtr			userRoutine);
EXTERN_API(OSErr)
CallLg2PhysProc				   (Lg2PhysUPP				userRoutine,
								void *					fsdGlobalPtr,
...
#if MIXEDMODE_CALLS_ARE_FUNCTIONS
EXTERN_API(HFSCIUPP)
NewHFSCIProc				   (HFSCIProcPtr			userRoutine);
EXTERN_API(OSErr)
CallHFSCIProc				   (HFSCIUPP				userRoutine,
								VCBPtr					theVCB,
								short					selectCode,
								void *					paramBlock,
								void *					fsdGlobalPtr,
...
#if MIXEDMODE_CALLS_ARE_FUNCTIONS
EXTERN_API(DICIUPP)
NewDICIProc					   (DICIProcPtr				userRoutine);
EXTERN_API(OSErr)
CallDICIProc				   (DICIUPP					userRoutine,
								short					whatFunction,
								void *					paramBlock,
								void *					fsdGlobalPtr);
#else
...
NewFSDCommProc				   (FSDCommProcPtr			userRoutine);
EXTERN_API(OSErr)
CallFSDCommProc				   (FSDCommUPP				userRoutine,
								short					message,
								void *					paramBlock,
								void *					globalsPtr);
#else

...
NewgxUserErrorProc			   (gxUserErrorProcPtr		userRoutine);
EXTERN_API(gxUserWarningUPP)
NewgxUserWarningProc		   (gxUserWarningProcPtr	userRoutine);
EXTERN_API(gxUserNoticeUPP)
NewgxUserNoticeProc			   (gxUserNoticeProcPtr		userRoutine);
EXTERN_API(void)
CallgxUserErrorProc			   (gxUserErrorUPP			userRoutine,
								gxGraphicsError			status,
								long					refcon);
EXTERN_API(void)
CallgxUserWarningProc		   (gxUserWarningUPP		userRoutine,
								gxGraphicsWarning		status,
								long					refcon);
EXTERN_API(void)
CallgxUserNoticeProc		   (gxUserNoticeUPP			userRoutine,

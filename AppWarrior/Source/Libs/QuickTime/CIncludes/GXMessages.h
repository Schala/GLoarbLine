...
NewMessageHandlerOverrideProc    (MessageHandlerOverrideProcPtr userRoutine);
EXTERN_API(OSErr)
CallMessageHandlerOverrideProc    (MessageHandlerOverrideUPP userRoutine,
								long					arg1,
								long					arg2,
								long					arg3,
								long					arg4,
...
NewMessageGlobalsInitProc	   (MessageGlobalsInitProcPtr userRoutine);
EXTERN_API(void)
CallMessageGlobalsInitProc	   (MessageGlobalsInitUPP	userRoutine,
								void *					messageGlobals);
#else

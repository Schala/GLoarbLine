...
NewSelectorFunctionProc		   (SelectorFunctionProcPtr	userRoutine);
EXTERN_API(OSErr)
CallSelectorFunctionProc	   (SelectorFunctionUPP		userRoutine,
								OSType					selector,
								long *					response);
#else
...
enum {
	...
	gestaltX86Reserved18		= 18,							/* do not count on this bit value*/
	gestaltX86Reserved19		= 19,							/* do not count on this bit value*/
	gestaltX86Reserved20		= 20,							/* do not count on this bit value*/
	gestaltX86Reserved21		= 21,							/* do not count on this bit value*/
	gestaltX86Reserved22		= 22,							/* do not count on this bit value*/
	...
	gestaltX86Reserved25		= 25,							/* do not count on this bit value*/
	gestaltX86Reserved26		= 26,							/* do not count on this bit value*/
	gestaltX86Reserved27		= 27,							/* do not count on this bit value*/
	gestaltX86Reserved28		= 28,							/* do not count on this bit value*/
	gestaltX86Reserved29		= 29,							/* do not count on this bit value*/
	gestaltX86Reserved30		= 30,							/* do not count on this bit value*/
	gestaltX86Reserved31		= 31							/* do not count on this bit value*/
};

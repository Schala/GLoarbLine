...
/*--------------------------------------------------------------------------------------*/
/*	o Gestalt and Errors (Mac OS 8.5 and later)											*/
/*--------------------------------------------------------------------------------------*/
...
EXTERN_API_C( void )
SetMenuItemHotKey				(MenuHandle 			menu,
								 short 					itemID,
								 char 					hotKey,
								 long 					flags);
...
NewMenuDefProc				   (MenuDefProcPtr			userRoutine);
EXTERN_API(MenuBarDefUPP)
NewMenuBarDefProc			   (MenuBarDefProcPtr		userRoutine);
EXTERN_API(MenuHookUPP)
NewMenuHookProc				   (MenuHookProcPtr			userRoutine);
EXTERN_API(MBarHookUPP)
NewMBarHookProc				   (MBarHookProcPtr			userRoutine);
EXTERN_API(void)
CallMenuDefProc				   (MenuDefUPP				userRoutine,
								short					message,
								MenuHandle				theMenu,
								Rect *					menuRect,
								Point					hitPt,
								short *					whichItem);
EXTERN_API(long)
CallMenuBarDefProc			   (MenuBarDefUPP			userRoutine,
								short					selector,
								short					message,
								short					parameter1,
								long					parameter2);
EXTERN_API(void)
CallMenuHookProc			   (MenuHookUPP				userRoutine);
EXTERN_API(short)
CallMBarHookProc			   (MBarHookUPP				userRoutine,
								Rect *					menuRect);
#else
...
EXTERN_API( OSStatus )
GetMenuFont						(MenuHandle 			menu,
								 SInt16 *				outFontID,
								 UInt16 *				outFontSize);

EXTERN_API( OSStatus )
SetMenuFont						(MenuHandle 			menu,
								 SInt16 				inFontID,
								 UInt16 				inFontSize);

EXTERN_API( Boolean )
GetMenuExcludesMarkColumn		(MenuHandle 			menu);

EXTERN_API( OSStatus )
SetMenuExcludesMarkColumn		(MenuHandle 			menu,
...
EXTERN_API( OSStatus )
AppendMenuItemText				(MenuHandle 			menu,
								 ConstStr255Param 		inString);

EXTERN_API( OSStatus )
InsertMenuItemText				(MenuHandle 			menu,
								 ConstStr255Param 		inString,
								 UInt16 				afterItem);
...
#endif
EXTERN_API( void )
MacEnableMenuItem				(MenuHandle 			theMenu,
								 UInt16 				item);

EXTERN_API( void )
DisableMenuItem					(MenuHandle 			theMenu,
								 UInt16 				item);

EXTERN_API( Boolean )
IsMenuItemEnabled				(MenuHandle 			menu,
								 UInt16 				item);

EXTERN_API( void )
EnableMenuItemIcon				(MenuHandle 			theMenu,
								 UInt16 				item)								THREEWORDINLINE(0x303C, 0x0019, 0xA825);

EXTERN_API( void )
DisableMenuItemIcon				(MenuHandle 			theMenu,
								 UInt16 				item)								THREEWORDINLINE(0x303C, 0x0020, 0xA825);

EXTERN_API( Boolean )
IsMenuItemIconEnabled			(MenuHandle 			menu,
								 UInt16 				item)								THREEWORDINLINE(0x303C, 0x0018, 0xA825);
...
/*--------------------------------------------------------------------------------------*/
EXTERN_API( OSStatus )
GetMenuItemProperty				(MenuHandle 			menu,
								 UInt16 				item,
...
EXTERN_API( OSStatus )
GetMenuItemPropertySize			(MenuHandle 			menu,
								 UInt16 				item,
								 OSType 				propertyCreator,
								 OSType 				propertyTag,
								 UInt32 *				size);
...
EXTERN_API( OSStatus )
SetMenuItemProperty				(MenuHandle 			menu,
								 UInt16 				item,
								 OSType 				propertyCreator,
								 OSType 				propertyTag,
								 UInt32 				propertySize,
...
EXTERN_API( OSStatus )
RemoveMenuItemProperty			(MenuHandle 			menu,
								 UInt16 				item,
								 OSType 				propertyCreator,
								 OSType 				propertyTag);

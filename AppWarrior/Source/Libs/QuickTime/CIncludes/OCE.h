...
NewDSSpecStreamerProc		   (DSSpecStreamerProcPtr	userRoutine);
EXTERN_API(OSErr)
CallDSSpecStreamerProc		   (DSSpecStreamerUPP		userRoutine,
								void *					buffer,
								unsigned long			count,
								Boolean					eof,
								long					userData);
...
NewOCERecipientStreamerProc	   (OCERecipientStreamerProcPtr userRoutine);
EXTERN_API(OSErr)
CallOCERecipientStreamerProc    (OCERecipientStreamerUPP userRoutine,
								void *					buffer,
								unsigned long			count,
								Boolean					eof,
								long					userData);

...
EXTERN_API(void)
CallAuthIOCompletionProc	   (AuthIOCompletionUPP		userRoutine,
								AuthParamBlockPtr		paramBlock);
EXTERN_API(Boolean)
CallNotificationProc		   (NotificationUPP			userRoutine,
								long					clientData,
								AuthLocalIdentityOp		callValue,
								AuthLocalIdentityLockAction actionValue,
								LocalIdentity			identity);
EXTERN_API(void)
CallDirIOCompletionProc		   (DirIOCompletionUPP		userRoutine,
								DirParamBlockPtr		paramBlock);
EXTERN_API(Boolean)
CallForEachDirEnumSpecProc	   (ForEachDirEnumSpecUPP	userRoutine,
								long					clientData,
								const DirEnumSpec *		enumSpec);
EXTERN_API(Boolean)
CallForEachRecordProc		   (ForEachRecordUPP		userRoutine,
								long					clientData,
								const DirEnumSpec *		enumSpec,
								PackedRLIPtr			pRLI);
EXTERN_API(Boolean)
CallForEachLookupRecordIDProc    (ForEachLookupRecordIDUPP userRoutine,
								long					clientData,
								const RecordID *		recordID);
EXTERN_API(Boolean)
CallForEachAttrTypeLookupProc    (ForEachAttrTypeLookupUPP userRoutine,
								long					clientData,
								const AttributeType *	attrType,
								AccessMask				myAttrAccMask);
EXTERN_API(Boolean)
CallForEachAttrValueProc	   (ForEachAttrValueUPP		userRoutine,
								long					clientData,
								const Attribute *		attribute);
EXTERN_API(Boolean)
CallForEachAttrTypeProc		   (ForEachAttrTypeUPP		userRoutine,
								long					clientData,
								const AttributeType *	attrType);
EXTERN_API(Boolean)
CallForEachRecordIDProc		   (ForEachRecordIDUPP		userRoutine,
								long					clientData,
								const RecordID *		recordID);
EXTERN_API(Boolean)
CallForEachDirectoryProc	   (ForEachDirectoryUPP		userRoutine,
								long					clientData,
								const DirectoryName *	dirName,
								const DirDiscriminator * discriminator,
								DirGestalt				features);
EXTERN_API(Boolean)
CallForEachADAPDirectoryProc    (ForEachADAPDirectoryUPP userRoutine,
								long					clientData,
								const DirectoryName *	dirName,
								const DirDiscriminator * discriminator,
								DirGestalt				features,
								AddrBlock				serverHint);
EXTERN_API(Boolean)
CallForEachDNodeAccessControlProc    (ForEachDNodeAccessControlUPP userRoutine,
								long					clientData,
								const DSSpec *			dsObj,
...
EXTERN_API(Boolean)
CallForEachRecordAccessControlProc    (ForEachRecordAccessControlUPP userRoutine,
								long					clientData,
								const DSSpec *			dsObj,
								AccessMask				activeDnodeAccMask,
								...
								AccessMask				defaultAttributeAccMask);
EXTERN_API(Boolean)
CallForEachAttributeAccessControlProc    (ForEachAttributeAccessControlUPP userRoutine,
								long					clientData,
								const DSSpec *			dsObj,
								AccessMask				activeDnodeAccMask,
								AccessMask				activeRecordAccMask,
...
EXTERN_API(OSErr)
CallDSAMDirProc				   (DSAMDirUPP				userRoutine,
								void *					dsamData,
								DirParamBlockPtr		paramBlock,
								Boolean					async);
EXTERN_API(OSErr)
CallDSAMDirParseProc		   (DSAMDirParseUPP			userRoutine,
								void *					dsamData,
								DirParamBlockPtr		paramBlock,
								Boolean					async);
EXTERN_API(OSErr)
CallDSAMAuthProc			   (DSAMAuthUPP				userRoutine,
								void *					dsamData,
								AuthParamBlockPtr		pb,
								Boolean					async);
EXTERN_API(AuthIOCompletionUPP)
NewAuthIOCompletionProc		   (AuthIOCompletionProcPtr	userRoutine);
EXTERN_API(NotificationUPP)
NewNotificationProc			   (NotificationProcPtr		userRoutine);
EXTERN_API(DirIOCompletionUPP)
NewDirIOCompletionProc		   (DirIOCompletionProcPtr	userRoutine);
EXTERN_API(ForEachDirEnumSpecUPP)
NewForEachDirEnumSpecProc	   (ForEachDirEnumSpecProcPtr userRoutine);
EXTERN_API(ForEachRecordUPP)
NewForEachRecordProc		   (ForEachRecordProcPtr	userRoutine);
EXTERN_API(ForEachLookupRecordIDUPP)
NewForEachLookupRecordIDProc    (ForEachLookupRecordIDProcPtr userRoutine);
EXTERN_API(ForEachAttrTypeLookupUPP)
NewForEachAttrTypeLookupProc    (ForEachAttrTypeLookupProcPtr userRoutine);
EXTERN_API(ForEachAttrValueUPP)
NewForEachAttrValueProc		   (ForEachAttrValueProcPtr	userRoutine);
EXTERN_API(ForEachAttrTypeUPP)
NewForEachAttrTypeProc		   (ForEachAttrTypeProcPtr	userRoutine);
EXTERN_API(ForEachRecordIDUPP)
NewForEachRecordIDProc		   (ForEachRecordIDProcPtr	userRoutine);
EXTERN_API(ForEachDirectoryUPP)
NewForEachDirectoryProc		   (ForEachDirectoryProcPtr	userRoutine);
EXTERN_API(ForEachADAPDirectoryUPP)
NewForEachADAPDirectoryProc	   (ForEachADAPDirectoryProcPtr userRoutine);
EXTERN_API(ForEachDNodeAccessControlUPP)
NewForEachDNodeAccessControlProc    (ForEachDNodeAccessControlProcPtr userRoutine);
EXTERN_API(ForEachRecordAccessControlUPP)
NewForEachRecordAccessControlProc    (ForEachRecordAccessControlProcPtr userRoutine);
EXTERN_API(ForEachAttributeAccessControlUPP)
NewForEachAttributeAccessControlProc    (ForEachAttributeAccessControlProcPtr userRoutine);
EXTERN_API(DSAMDirUPP)
NewDSAMDirProc				   (DSAMDirProcPtr			userRoutine);
EXTERN_API(DSAMDirParseUPP)
NewDSAMDirParseProc			   (DSAMDirParseProcPtr		userRoutine);
EXTERN_API(DSAMAuthUPP)
NewDSAMAuthProc				   (DSAMAuthProcPtr			userRoutine);
#else

...
EXTERN_API(OSErr)
CallDETCallBackProc			   (DETCallBackUPP			userRoutine,
								DETCallBlock *			callBlockPtr,
								DETCallBackBlockPtr		callBackBlockPtr);
EXTERN_API(DETCallBackUPP)
NewDETCallBackProc			   (DETCallBackProcPtr		userRoutine);
#else
...
NewDETCallProc				   (DETCallProcPtr			userRoutine);
EXTERN_API(OSErr)
CallDETCallProc				   (DETCallUPP				userRoutine,

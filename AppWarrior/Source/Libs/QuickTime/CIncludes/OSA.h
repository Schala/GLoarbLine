...
NewOSACreateAppleEventProc	   (OSACreateAppleEventProcPtr userRoutine);
EXTERN_API(OSASendUPP)
NewOSASendProc				   (OSASendProcPtr			userRoutine);
EXTERN_API(OSErr)
CallOSACreateAppleEventProc	   (OSACreateAppleEventUPP	userRoutine,
								...
								long					refCon);
EXTERN_API(OSErr)
CallOSASendProc				   (OSASendUPP				userRoutine,
...
NewOSAActiveProc			   (OSAActiveProcPtr		userRoutine);
EXTERN_API(OSErr)
CallOSAActiveProc			   (OSAActiveUPP			userRoutine,
								long					refCon);
#else

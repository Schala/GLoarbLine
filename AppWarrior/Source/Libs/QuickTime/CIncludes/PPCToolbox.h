/*
 	...
 	Copyright:	(c) 1989-1993, 1995-1998 by Apple Computer, Inc., all rights reserved
...
NewPPCCompProc				   (PPCCompProcPtr			userRoutine);
EXTERN_API(PPCFilterUPP)
NewPPCFilterProc			   (PPCFilterProcPtr		userRoutine);
EXTERN_API(void)
CallPPCCompProc				   (PPCCompUPP				userRoutine,
								PPCParamBlockPtr		pb);
EXTERN_API(Boolean)
CallPPCFilterProc			   (PPCFilterUPP			userRoutine,

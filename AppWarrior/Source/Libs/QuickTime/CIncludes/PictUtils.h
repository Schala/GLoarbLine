...
NewInitPickMethodProc		   (InitPickMethodProcPtr	userRoutine);
EXTERN_API(OSErr)
CallInitPickMethodProc		   (InitPickMethodUPP		userRoutine,
...
NewRecordColorsProc			   (RecordColorsProcPtr		userRoutine);
EXTERN_API(OSErr)
CallRecordColorsProc		   (RecordColorsUPP			userRoutine,
								UInt32					dataRef,
...
NewCalcColorTableProc		   (CalcColorTableProcPtr	userRoutine);
EXTERN_API(OSErr)
CallCalcColorTableProc		   (CalcColorTableUPP		userRoutine,
								UInt32					dataRef,
								SInt16					colorsRequested,
								void *					colorBankPtr,
...
NewDisposeColorPickMethodProc    (DisposeColorPickMethodProcPtr userRoutine);
EXTERN_API(OSErr)
CallDisposeColorPickMethodProc    (DisposeColorPickMethodUPP userRoutine,
								UInt32					dataRef);
#else

...
NewMusicMIDISendProc		   (MusicMIDISendProcPtr	userRoutine);
EXTERN_API(MusicMIDIReadHookUPP)
NewMusicMIDIReadHookProc	   (MusicMIDIReadHookProcPtr userRoutine);
EXTERN_API(MusicOfflineDataUPP)
NewMusicOfflineDataProc		   (MusicOfflineDataProcPtr	userRoutine);
EXTERN_API(TuneCallBackUPP)
NewTuneCallBackProc			   (TuneCallBackProcPtr		userRoutine);
EXTERN_API(TunePlayCallBackUPP)
NewTunePlayCallBackProc		   (TunePlayCallBackProcPtr	userRoutine);
EXTERN_API(ComponentResult)
CallMusicMIDISendProc		   (MusicMIDISendUPP		userRoutine,
								ComponentInstance		self,
								long					refCon,
								MusicMIDIPacket *		mmp);
EXTERN_API(ComponentResult)
CallMusicMIDIReadHookProc	   (MusicMIDIReadHookUPP	userRoutine,
								MusicMIDIPacket *		mp,
								long					myRefCon);
EXTERN_API(ComponentResult)
CallMusicOfflineDataProc	   (MusicOfflineDataUPP		userRoutine,
								Ptr						SoundData,
								long					numBytes,
								long					myRefCon);
EXTERN_API(void)
CallTuneCallBackProc		   (TuneCallBackUPP			userRoutine,
								const TuneStatus *		status,
								long					refCon);
EXTERN_API(void)
CallTunePlayCallBackProc	   (TunePlayCallBackUPP		userRoutine,
								unsigned long *			event,
								long					seed,
								long					refCon);
#else

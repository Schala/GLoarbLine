...
NewPCCardSSEntryProc		   (PCCardSSEntryProcPtr	userRoutine);
EXTERN_API(short)
CallPCCardSSEntryProc		   (PCCardSSEntryUPP		userRoutine,
								UInt16					fnCode,
								Ptr						callPB,
								Ptr						dataPtr);
#else
...
NewPCCardCSEntryProc		   (PCCardCSEntryProcPtr	userRoutine);
EXTERN_API(void)
CallPCCardCSEntryProc		   (PCCardCSEntryUPP		userRoutine,
								CSEventEntryPB *		pb);
#else

...
NewSpeechTextDoneProc		   (SpeechTextDoneProcPtr	userRoutine);
EXTERN_API(SpeechDoneUPP)
NewSpeechDoneProc			   (SpeechDoneProcPtr		userRoutine);
EXTERN_API(SpeechSyncUPP)
NewSpeechSyncProc			   (SpeechSyncProcPtr		userRoutine);
EXTERN_API(SpeechErrorUPP)
NewSpeechErrorProc			   (SpeechErrorProcPtr		userRoutine);
EXTERN_API(SpeechPhonemeUPP)
NewSpeechPhonemeProc		   (SpeechPhonemeProcPtr	userRoutine);
EXTERN_API(SpeechWordUPP)
NewSpeechWordProc			   (SpeechWordProcPtr		userRoutine);
EXTERN_API(void)
CallSpeechTextDoneProc		   (SpeechTextDoneUPP		userRoutine,
								SpeechChannel			chan,
								long					refCon,
								const void **			nextBuf,
								...
								long *					controlFlags);
EXTERN_API(void)
CallSpeechDoneProc			   (SpeechDoneUPP			userRoutine,
								SpeechChannel			chan,
								long					refCon);
EXTERN_API(void)
CallSpeechSyncProc			   (SpeechSyncUPP			userRoutine,
								SpeechChannel			chan,
								long					refCon,
								OSType					syncMessage);
EXTERN_API(void)
CallSpeechErrorProc			   (SpeechErrorUPP			userRoutine,
								SpeechChannel			chan,
								long					refCon,
								OSErr					theError,
								long					bytePos);
EXTERN_API(void)
CallSpeechPhonemeProc		   (SpeechPhonemeUPP		userRoutine,
								SpeechChannel			chan,
								long					refCon,
								short					phonemeOpcode);
EXTERN_API(void)
CallSpeechWordProc			   (SpeechWordUPP			userRoutine,
								SpeechChannel			chan,
								long					refCon,

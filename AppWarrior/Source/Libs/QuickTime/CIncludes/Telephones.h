...
NewTelephoneTermMsgProc		   (TelephoneTermMsgProcPtr	userRoutine);
EXTERN_API(TelephoneDNMsgUPP)
NewTelephoneDNMsgProc		   (TelephoneDNMsgProcPtr	userRoutine);
EXTERN_API(TelephoneCAMsgUPP)
NewTelephoneCAMsgProc		   (TelephoneCAMsgProcPtr	userRoutine);
EXTERN_API(TelephoneChooseIdleUPP)
NewTelephoneChooseIdleProc	   (TelephoneChooseIdleProcPtr userRoutine);
EXTERN_API(void)
CallTelephoneTermMsgProc	   (TelephoneTermMsgUPP		userRoutine,
								TELHandle				hTEL,
								long					msg,
								short					mtype,
								short					value,
								long					globals);
EXTERN_API(void)
CallTelephoneDNMsgProc		   (TelephoneDNMsgUPP		userRoutine,
								TELDNHandle				hTELDN,
								long					Msg,
								short					mtype,
								short					value,
								...
								long					globals);
EXTERN_API(void)
CallTelephoneCAMsgProc		   (TelephoneCAMsgUPP		userRoutine,
								TELCAHandle				hTELCA,
								long					Msg,
								short					mtype,
								short					value,
								...
								long					globals);
EXTERN_API(void)
CallTelephoneChooseIdleProc	   (TelephoneChooseIdleUPP	userRoutine);
#else

...
enum {
	...
	kTextEncodingMacUkrainian	= 0x98,							/* The following use script code 28, smEthiopic*/
...
enum {
	...
	kMacRomanStandardVariant	= 0,							/* standard for Mac OS 8.5, 0xDB is EURO SIGN*/
	kMacRomanCurrencySignVariant = 1,							/* earlier Mac OS versions, 0xDB is CURRENCY SIGN*/

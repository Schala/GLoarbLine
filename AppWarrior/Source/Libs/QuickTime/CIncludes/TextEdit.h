...
NewHighHookProc				   (HighHookProcPtr			userRoutine);
EXTERN_API(EOLHookUPP)
NewEOLHookProc				   (EOLHookProcPtr			userRoutine);
EXTERN_API(CaretHookUPP)
NewCaretHookProc			   (CaretHookProcPtr		userRoutine);
EXTERN_API(WidthHookUPP)
NewWidthHookProc			   (WidthHookProcPtr		userRoutine);
EXTERN_API(TextWidthHookUPP)
NewTextWidthHookProc		   (TextWidthHookProcPtr	userRoutine);
EXTERN_API(NWidthHookUPP)
NewNWidthHookProc			   (NWidthHookProcPtr		userRoutine);
EXTERN_API(DrawHookUPP)
NewDrawHookProc				   (DrawHookProcPtr			userRoutine);
EXTERN_API(HitTestHookUPP)
NewHitTestHookProc			   (HitTestHookProcPtr		userRoutine);
EXTERN_API(TEFindWordUPP)
NewTEFindWordProc			   (TEFindWordProcPtr		userRoutine);
EXTERN_API(TERecalcUPP)
NewTERecalcProc				   (TERecalcProcPtr			userRoutine);
EXTERN_API(TEDoTextUPP)
NewTEDoTextProc				   (TEDoTextProcPtr			userRoutine);
EXTERN_API(TEClickLoopUPP)
NewTEClickLoopProc			   (TEClickLoopProcPtr		userRoutine);
EXTERN_API(WordBreakUPP)
NewWordBreakProc			   (WordBreakProcPtr		userRoutine);
EXTERN_API(void)
CallHighHookProc			   (HighHookUPP				userRoutine,
								const Rect *			r,
								TEPtr					pTE);
EXTERN_API(Boolean)
CallEOLHookProc				   (EOLHookUPP				userRoutine,
								char					theChar,
								TEPtr					pTE,
								TEHandle				hTE);
EXTERN_API(void)
CallCaretHookProc			   (CaretHookUPP			userRoutine,
								const Rect *			r,
								TEPtr					pTE);
EXTERN_API(unsigned short)
CallWidthHookProc			   (WidthHookUPP			userRoutine,
								...
								TEHandle				hTE);
EXTERN_API(unsigned short)
CallTextWidthHookProc		   (TextWidthHookUPP		userRoutine,
								unsigned short			textLen,
								unsigned short			textOffset,
								void *					textBufferPtr,
								TEPtr					pTE,
								TEHandle				hTE);
EXTERN_API(unsigned short)
CallNWidthHookProc			   (NWidthHookUPP			userRoutine,
								...
								TEHandle				hTE);
EXTERN_API(void)
CallDrawHookProc			   (DrawHookUPP				userRoutine,
								unsigned short			textOffset,
								...
								TEHandle				hTE);
EXTERN_API(Boolean)
CallHitTestHookProc			   (HitTestHookUPP			userRoutine,
								unsigned short			styleRunLen,
								unsigned short			styleRunOffset,
								unsigned short			slop,
								void *					textBufferPtr,
								...
								Boolean *				pixelInChar);
EXTERN_API(void)
CallTEFindWordProc			   (TEFindWordUPP			userRoutine,
...
EXTERN_API(void)
CallTERecalcProc			   (TERecalcUPP				userRoutine,
								TEPtr					pTE,
...
EXTERN_API(void)
CallTEDoTextProc			   (TEDoTextUPP				userRoutine,
								TEPtr					pTE,
								unsigned short			firstChar,
								unsigned short			lastChar,
								short					selector,
								...
								short *					charPosition);
EXTERN_API(Boolean)
CallTEClickLoopProc			   (TEClickLoopUPP			userRoutine,
								TEPtr					pTE);
EXTERN_API(Boolean)
CallWordBreakProc			   (WordBreakUPP			userRoutine,
								Ptr						text,
								short					charPos);
#else
